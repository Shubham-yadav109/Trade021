...
// import 'package:shared_preferences/shared_preferences.dart'; // TODO: save search history
...
class _HomeScreen extends State<HomeScreen> {
  ...
  void initState() {
    ...
    Future.doWhile(() async {
      ...
      context.read<StockBloc>().add(const RefreshPricesRequested());
      return true;
    });
  }
  @override
            ...
            Padding(
              ...
              child: TextField(
                decoration: InputDecoration(
                  hintText: "Search for instruments (WIP)",
  ...
  Widget _tab(BuildContext context, String text, int index, int selected) {
    return GestureDetector(
      onTap: () {
        context.read<StockBloc>().add(WatchlistTabChanged(index));
      },
      child: Padding(
